      ...
      <div className="hidden lg:flex flex-1 flex-col min-h-0 relative">
         <AnimatePresence mode="wait">
            {selectedJob ? (
               ...
               >
                  <Card className="flex-1 bg-card/20 border-border/40 backdrop-blur-xl rounded-3xl overflow-hidden flex flex-col relative border-2 shadow-2xl">
                     {/* Visual Header */}
                     <div className="h-48 bg-gradient-to-br from-primary/20 via-primary/5 to-transparent relative p-10 flex items-end shrink-0">
                        <div className="space-y-3 z-10 w-full">
                           <div className="flex items-center justify-between w-full">
                              <div className="space-y-1">
                                 <div className="flex items-center gap-3">
                                    ...
                                    <span className="text-[10px] font-black text-muted-foreground uppercase tracking-widest opacity-60 flex items-center gap-1.5">
                                       ...
                                       <a href={selectedJob.link} target="_blank" rel="noopener noreferrer" className="ml-2 hover:text-primary transition-colors">
                              ...
                              <div className="flex flex-col items-center gap-1">
                                 ...
                                 <span className="text-4xl font-black text-primary tabular-nums tracking-tighter shadow-primary/20">{selectedJob.fitScore}%</span>
                              </div>
                           </div>
                        </div>
                        {/* Background Texture */}
                     ...
                     <ScrollArea className="flex-1 px-10">
                        <div className="py-8 space-y-10">
                           ...
                           <div className="space-y-4">
                              ...
                              <div className="bg-primary/5 border-2 border-primary/20 p-6 rounded-2xl flex items-center justify-between">
                                 <div className="space-y-1">
                                    ...
                                    <p className="text-2xl font-black text-foreground tabular-nums tracking-tighter">{selectedJob.salary}</p>
                                 </div>
                           ...
                           {/* Action Matrix */}
                           <div className="pt-8 border-t border-border/20 grid grid-cols-2 gap-6 pb-12">
                              <Button 
                                 onClick={() => window.open(selectedJob.link, '_blank')}
                                 className="h-14 bg-primary hover:bg-primary/90 text-primary-foreground font-black uppercase tracking-[0.2em] text-[10px] rounded-2xl shadow-xl shadow-primary/20 flex items-center justify-center gap-3"
                              >
               ...
               <div className="flex-1 flex flex-col items-center justify-center text-center space-y-6 bg-card/10 border-2 border-dashed border-border/20 rounded-[3rem] m-6 backdrop-blur-sm">
                   ...
                   <div className="space-y-2">
                      ...
                      <p className="text-[10px] font-bold text-muted-foreground/60 uppercase tracking-widest max-w-[200px] leading-relaxed">
